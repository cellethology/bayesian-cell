function xhat = SDE_euler_mod(bigtheta,PROBLEM,OWNTIME,NUMDEPVARS,NUMSIM,SDETYPE,param,input)
%
...
error(nargchk(8, 8, nargin));   % Yuan 1/22/10
[n1,n2]=rat(NUMSIM);
...
[t, xstart] = feval([PROBLEM, '_sde'],OWNTIME(1),[],'init',bigtheta,SDETYPE,NUMDEPVARS,NUMSIM,param,input); % Yuan 1/22/10
...
%     waitbar((j-1)/(N-1));
    ...
    [f,g] = feval([PROBLEM, '_sde'], t, x, [], bigtheta,SDETYPE,NUMDEPVARS,NUMSIM,param,input);  % Yuan 1/22/10
