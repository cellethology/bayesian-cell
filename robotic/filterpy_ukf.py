"""
FilterPy-based Unscented Kalman Filter implementation for target tracking.
...
class FilterPyUnscentedKalmanFilter(BaseFilter):
    """Unscented Kalman Filter using FilterPy library for target tracking."""
    ...
    def __init__(self, config):
        ...
        self.alpha = config.get("ukf_alpha", 1.0)
        self.beta = config.get("ukf_beta", 2.0)
        self.kappa = config.get("ukf_kappa", 1.0)
